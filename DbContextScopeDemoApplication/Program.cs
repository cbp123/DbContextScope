	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			try
			{
				...
				UserCreationSpec marysSpec = new UserCreationSpec("Mary", "mary@example.com");
				...
				UserCreationSpec johnSpec = new UserCreationSpec("John", "john@example.com");
				UserCreationSpec jeanneSpec = new UserCreationSpec("Jeanne", "jeanne@example.com");
				...
				UserCreationSpec julieSpec = new UserCreationSpec("Julie", "julie@example.com");
				UserCreationSpec marcSpec = new UserCreationSpec("Marc", "marc@example.com");
				try
				{
